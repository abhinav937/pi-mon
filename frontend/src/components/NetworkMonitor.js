...
const NetworkMonitor = ({ unifiedClient }) => {
  ...
  const getInterfaceIcon = (type) => {
    switch (type?.toLowerCase()) {
      case 'wifi':
      case 'wireless':
        return <Wifi className="h-5 w-5 accent-text" />;
      case 'ethernet':
      case 'wired':
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <select
          ...
          className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2"
        >
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="flex items-center space-x-2">
                    <Download className="h-4 w-4 accent-text" />
                    <div>
