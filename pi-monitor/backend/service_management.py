...
class ServiceManager:
    ...
    def __init__(self):
        ...
        # Common services to monitor on Raspberry Pi
    ...
    def _check_privileges(self):
        ...
        try:
            ...
            logger.info("Service management initialized", has_systemctl=self.has_systemctl)
    ...
    async def execute_action(self, service_name: str, action: str) -> str:
        ...
        """
        if not self.has_systemctl:
            raise Exception("systemctl not available or insufficient privileges")
